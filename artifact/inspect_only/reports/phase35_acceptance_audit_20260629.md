...
| rq_ladder: RQ1-RQ4 ladder is visible | PASS | 8 | RQ1=2, RQ2=2, RQ3=3, RQ4=1 | Keep RQs as prevalence, stronger evidence, operational value, and boundary. |
| denominators: Headline counts include denominators | PASS | 8 | 35 ratio-like counts found | Every headline result should show denominator and selected-set boundary. |
...
| claim_boundary: Non-oracle and non-population claim boundaries are explicit | PASS | 10 | 22 boundary signals found | Repeat non-oracle and non-population boundaries in abstract/results/threats. |
...
| artifact_checkability: Artifact checkability is reviewer-visible | PASS | 10 | manuscript_signals=23; 138 files; verifier=True; scan=True; data_like_files=77 | Name Level 1 verifier and shipped CSV/JSONL/Markdown inputs; keep secret scan current. |
...
| case_traceability: Case studies include traceable certificate evidence | PASS | 7 | 94 certificate/id-like signals found | Each case should include certificate ID/suffix, behavior split, and non-oracle boundary. |
| table_figure_anchors: Claims are anchored to tables or figures | PASS | 6 | 27 table/figure reference signals found | Every RQ answer should point to a specific table, figure, or case-study evidence. |
