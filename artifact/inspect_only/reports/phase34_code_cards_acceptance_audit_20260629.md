...
| table_figure_anchors: Claims are anchored to tables or figures | PASS | 6 | 25 table/figure reference signals found | Every RQ answer should point to a specific table, figure, or case-study evidence. |
