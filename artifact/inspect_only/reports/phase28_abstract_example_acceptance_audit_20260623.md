...
| artifact_checkability: Artifact checkability is reviewer-visible | PASS | 10 | manuscript_signals=24; 126 files; verifier=True; scan=True; data_like_files=65 | Name Level 1 verifier and shipped CSV/JSONL/Markdown inputs; keep secret scan current. |
...
| case_traceability: Case studies include traceable certificate evidence | PASS | 7 | 88 certificate/id-like signals found | Each case should include certificate ID/suffix, behavior split, and non-oracle boundary. |
