...
- Phase 33 IEEE conference-template binding using the supplied `IEEEtran.cls`, `\documentclass[conference]{IEEEtran}`, and `\IEEEoverridecommandlockouts`,
...
- `patchcourt_icse2027_anonymous_inspect_only_20260629_ieeetemplate.zip`
