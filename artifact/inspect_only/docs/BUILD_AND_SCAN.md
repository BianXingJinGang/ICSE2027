...
- `paper/icse2027/artifact_bundle_anonymous_20260528/patchcourt_icse2027_anonymous_inspect_only_20260628_structpatch.zip`
...
- Current main-paper figure PDFs, the Phase 26 quantitative Figure 1-4 redesign assets with the Phase 27 structured-edit inset, the Phase 30 structured patch-record listing in LaTeX, figure provenance inputs, and the 2026-06-22 quantitative chart pack.
...
- The exact Phase 30 rebuilt ZIP is extracted into a clean-room directory during final validation; Level 1 verification and LaTeX rebuild both pass.
- The Phase 30 critical secret/path scan passes on both the curated artifact directory and ZIP bytes after separating real token forms from benign task/probe names such as `flask-*`.
