#!/usr/bin/env python3
"""Regenerate and verify Level-1 PatchCourt table checks from bundled files.
...
CERTIFICATES = PACKAGE_ROOT / "certificates"
...
def main() -> int:
    ...
    summary = {
        "created_at": utc_now(),
        "package_root": "<PATCHCOURT_ROOT>",
        "level": "Level 1 table check",
